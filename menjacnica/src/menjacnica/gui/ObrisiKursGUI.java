...
public class ObrisiKursGUI extends JFrame {
	...
	public ObrisiKursGUI(MenjacnicaGUI glavniProzor, Valuta valuta) {
		...
		GUIKontroler.prikaziValutu(valuta, textFieldNaziv, textFieldSkraceniNaziv, textFieldSifra,
				textFieldProdajniKurs, textFieldKupovniKurs, textFieldSrednjiKurs);
	}
	...
	private JCheckBox getChckbxZaistaObrisiKurs() {
		if (chckbxZaistaObrisiKurs == null) {
			...
			chckbxZaistaObrisiKurs.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					GUIKontroler.zaistaObrisiKurs(chckbxZaistaObrisiKurs, btnDodaj);
				}
			});
		}
